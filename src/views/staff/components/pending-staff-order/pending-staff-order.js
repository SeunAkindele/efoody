...
import { StaffOrderCard, Info, LeftInfo, RightInfo, Trash, Check, Icon, IconInverse, HeaderFooterInfo } from "../staff-order-info-card/staff-order-info-card.styles";
import { Spacer } from "../../../../components/spacer/spacer.component";
import { url } from "../../../../api/url";

export const PendingStaffOrder = ({ pay_type, order, status, token, customer_id, loadOrder }) => {
